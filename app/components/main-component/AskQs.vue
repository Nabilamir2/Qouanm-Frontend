<template>
    ...
    >
      <div v-for="(faq, index) in faqsQuestion" :key="index" class="px-8 py-[24px] rounded-[20px] bg-white">
        <button
      ...
      <div>
        <span class="bg-black px-2 py-1 rounded-full " v-if="activeIndex === index">
